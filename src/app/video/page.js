    ...
    return (
        <div className="container h-screen flex flex-col justify-center items-center">
            ...
            <div className="webcam-container w-full h-full overflow-hidden">
                <iframe src="http://192.168.2.105:8080/browserfs.html" className="webcam-video w-full h-full" allow="autoplay" frameBorder="0" onError={(e) => console.error("Error loading iframe:", e)}></iframe>
            </div>
        </div>
    );
};
